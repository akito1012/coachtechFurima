    ...
    <div class="register__content">
        <form action="" class="register__form">
            ...
            <div class="register__item">
                ...
                <input id="password" type="text" class="item__input" name="password" value="{{ old('password') }}">
            </div>
            <div class="error">error</div>
            <div class="register__item">
                <label for="password_confirmation" class="item__label">確認用パスワード</label>
                <input id="password_confirmation" type="text" class="item__input" name="password_confirmation" value="{{ old('password_confirmation') }}">
            </div>
            <div class="error">error</div>
            <div class="button">
